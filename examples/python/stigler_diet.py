...
def main():
  ...
  nutrients = [['Calories (kcal)', 3], ['Protein (g)', 70],
               ['Calcium (g)', 0.8], ['Iron (mg)', 12], ['Vitamin A (KIU)', 5],
               ['Vitamin B1 (mg)', 1.8], ['Vitamin B2 (mg)', 2.7],
               ['Niacin (mg)', 18], ['Vitamin C (mg)', 75]]
  ...
  data = [
      ...
      [
          'Lamb Chops (Rib)', '1 lb.', 36.6, 3.3, 140, 0.1, 15, 0, 1.7, 2.7, 54,
          0
      ], ['Pork Chops', '1 lb.', 30.7, 3.5, 196, 0.2, 30, 0, 17.4, 2.7, 60, 0],
      [
          'Pork Loin Roast', '1 lb.', 24.2, 4.4, 249, 0.3, 37, 0, 18.2, 3.6, 79,
          0
      ...
      [
          'Pineapple (can)', 'No. 2 1/2', 21.3, 2.4, 16, 0.4, 8, 2, 2.8, 0.8, 7,
          399
      ],
      [
      ...
      [
          'Green Beans (can)', 'No. 2', 10, 1.0, 54, 2, 65, 53.9, 1.6, 4.3, 32,
          431
      ],
      [
      ...
      [
          'Tomatoes (can)', 'No. 2', 8.6, 1.3, 63, 0.7, 38, 53.2, 3.4, 2.5, 36,
          1253
      ],
      [
      ...
      [
          'Strawberry Preserves', '1 lb.', 20.5, 6.4, 11, 0.4, 7, 0.2, 0.2, 0.4,
          3, 0
      ]
  ]
